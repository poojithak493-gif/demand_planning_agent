...
from app.services.fetch_distributor_context_service import (
    FetchDistributorContextService,
)
from app.services.sku_recommendation_service import (
    SKURecommendationService,
)
from app.services.build_demand_email_service import (
    BuildDemandEmailService,
)
...
def get_recommendations(
    ...
    email_preview = email_service.execute(
        context,
        recommendations,
    )
